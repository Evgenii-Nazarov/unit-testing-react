...
const validateData = (formData) => {
    const validatedFormData = Object.entries(formData).map(([fieldName, fieldValue]) => {
        const { isValidateError, validateErrorText } = validateField(fieldName, fieldValue)
        console.log('isValidateError', isValidateError)
        console.log('validateErrorText', validateErrorText)
        console.log('obj', {
            ...fieldData,
            isValidateError,
            validateErrorText
